...
2. The app queries your local SearXNG instance with search queries formulated by a lightweight AI model and then retrieves, and round-robin merges the top 8 results per each queries (max 3 queries).
